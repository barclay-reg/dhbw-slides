...
*** Erstellen des [.blue]#PR# ist ein eindeutiger Trigger für
**** Start des Code-Reviews
**** Start von (langwierigen) automatisierten Tests

=== Wieso PR

* [.blue]#PR# im Umfeld von Original & Fork sind extrem hilfreich
[.step]
...
** mit dem Annehmen des [.blue]#PR# erlaubt der Maintainer, die "fremden" Commits in sein Repo aufzunehmen 
