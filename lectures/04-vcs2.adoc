...
. Interaktion zwischen [.blue]#lokalem Repository# und [.blue]#WorkCopy#
  * `git checkout master`
  * `git add README.md`
  * `git rm README.md`
...
[source, shell]
----
## leichtgewichteten Tag erstellen
$ git tag test-tag-1
## alle Tags anzeigen
$ git tag
release-1
...
[NOTE.speaker]
--
* Sinnvoll, um kurzfristig auf einen anderen Branch zu wechseln, ohne die aktuelle Arbeit committen zu müssen
--
