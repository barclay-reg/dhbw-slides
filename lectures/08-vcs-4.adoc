...
* Branch my-branch-1 existiert nur bei mir lokal
* Branch other-branch-2 existiert nur bei origin
--
...
[NOTE.speaker]
--
* Dies sind die Voraussetzungen, damit Git eine Synchronisierung durchführen kann
--
...
[NOTE.speaker]
--
* Alle commits der beiden Remote Branches wurden übertragen. Auch die Branchzeiger wurden übertragen, aber der Tracking-Branch (master) wurde nicht verändert - nun ist sichtbar, dass dieser von origin/master abweicht (diverged) - die Lösung dafür ist entweder ein 3WM oder ein Rebase+FF-Merge
--
