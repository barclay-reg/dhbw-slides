...
* https://barclay-reg.github.io/dhbw-slides/lectures/09-cleancode.html#/[10-continuous - Continuous Integration|Delivery]
* https://barclay-reg.github.io/dhbw-slides/lectures/09-cleancode.html#/[11-aufgaben-4 - Aufgaben für den 4. Praxisteil]
